...
def is_off_topic(query: str) -> bool:
    ...
    on_topic = [
        ...
        "батар", "аккумул", "корпус", "масса", "размер", "диаметр",
        "радиопередат", "бортов", "топлив", "давлени", "температур",
        "мощност", "сигнал", "частот", "орбитальн", "запасн",
    ]
